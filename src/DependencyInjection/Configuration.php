...
final class Configuration implements ConfigurationInterface
{
    ...
    public const DEPRECATION_MESSAGE_OPTION_NAME = 'deprecatedMessageName';
    public const DEPRECATION_FROM_OPTION_NAME = 'deprecatedFromName';
    public const DEPRECATION_SINCE_OPTION_NAME = 'deprecatedSinceName';
